...
//    Movie API로 출력된 dailyBoxOffice의 String을 Java 객체로 변환
    public static DailyBoxOfficeListResult returnMovieResponse(String movieAPIResult) throws JsonProcessingException {
        ObjectMapper movieObjectMapper = new ObjectMapper();
        DailyBoxOfficeListResult movieResponse = movieObjectMapper.readValue(movieAPIResult, DailyBoxOfficeListResult.class);
