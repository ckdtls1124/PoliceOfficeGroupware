...
//    Movie API ========================================================================
    ...
    public DailyBoxOfficeListResult findDailyBoxOfficeList(String dateAndTime) throws IOException {
        String dailyListString = MovieAPIExplorerJava.getMovieDataWithTodayBoxOffice(dateAndTime);
        DailyBoxOfficeListResult dailyListInResult = MovieAPIExplorerJava.returnMovieResponse(dailyListString);
...
//    private MessageDto movieAnalyzeToken(Set<String> nouns) {
//
//        LocalDateTime today = LocalDateTime.now();
//        DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("a H:mm");
//
