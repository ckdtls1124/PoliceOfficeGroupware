...
//   조회=======================================================================================
    ...
    public Page<MemorandumDto> findAllMemoNoSearch(PoliceEntity policeEntity, Pageable pageable) {
        Page<MemorandumEntity> memorandumEntityPage = memorandumRepository.findMemorandumByPolice(policeEntity, pageable);
    ...
    public List<MemoApprovedMemberDto> findMemoApprovedMemberApproved(Long policeId, Pageable pageable) {
        ...
        PoliceEntity policeEntity = this.makePoliceEntityWithSessionPoliceId(policeId);
        Page<MemorandumEntity> memorandumEntityPageList = memorandumRepository.findMemorandumByPolice(policeEntity, pageable);
...
//   수정=======================================================================================
    ...
    public void updateMemorandum(MemorandumDto memorandumDto, Long policeId) {
        PoliceEntity policeEntity = this.makePoliceEntityWithSessionPoliceId(policeId);
        MemorandumEntity memorandumEntity = MemorandumEntity.builder().memorandumId(memorandumDto.getMemorandumId()).memorandumContent(memorandumDto.getMemorandumContent()).police(policeEntity).build();
